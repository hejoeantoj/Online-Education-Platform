...
public class AssignmentSubmissionController {
    ...
    public ResponseEntity<ResultResponse<?>> getAllSubmissions(@Valid @RequestParam String courseId) {
        ResultResponse<List<AssignmentSubmission>> response = new ResultResponse<>();
            ...
            response.setMessage("Function Worked");
    ...
    /*
     * done during front end............
     * 
     * 
     */
    @GetMapping("/viewByCourseIdandAssignmentId")
    public ResponseEntity<ResultResponse<?>> getSubmissionsByCourseIdandAssignmentId(@Valid @RequestParam String courseId,@RequestParam String assignmentId) {
        ResultResponse<List<AssignmentSubmission>> response = new ResultResponse<>();
            List<AssignmentSubmission> submissions = assignmentSubmissionService.getSubmissionsByCourseIdandAssignmentId(courseId,assignmentId);
    ...
    @GetMapping("/verifySubmission")
    public ResponseEntity<ResultResponse<?>> verifySubmission(@Valid @RequestParam String studentId,@RequestParam String assignmentId) {
        ResultResponse<Boolean> response = new ResultResponse<>();
            boolean submissions = assignmentSubmissionService.verifySubmission(studentId,assignmentId);
    ...
    public ResponseEntity<ResultResponse<?>> assignmentReport(@Valid @RequestParam String studentId,@RequestParam String assignmentId) {
        ResultResponse<AssignmentReportDTO> response = new ResultResponse<>();
           
        AssignmentReportDTO submission = assignmentSubmissionService.assignmentReport(studentId,assignmentId);
          if(submission!=null){  
            response.setSuccess(true);
            response.setMessage("Submissions retrieved successfully");
