...
const AssignmentUploadForm = ({
    ...
    const handleFileChange = (e) => {
        // Stop propagation if clicking inside the input area shouldn't close the popup
        e.stopPropagation();
    ...
    if (isSubmitting) {
        ...
        // Use props.hasUploadedBefore for initial state, localUploadSuccess for after upload in this session
        buttonText = 'Uploaded!';
    }
            ...
            <form onSubmit={handleUpload}>
                <div className="file-input-container">
                    <input
                        ...
                        // Disable if already uploaded OR currently submitting
                ...
                >
                    {/* Add an icon if you have one, e.g., using FontAwesome */}
                    {/* <i className="fas fa-upload"></i>  */}
                    {buttonText}
                </button>
                {/* Show success check only after a successful upload in this session */}
