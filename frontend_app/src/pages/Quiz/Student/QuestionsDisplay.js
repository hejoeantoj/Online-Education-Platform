...
const QuestionsDisplay = () => {
  ...
  const calculateQuizDuration = () => (totalQuestionsCount !== null ? totalQuestionsCount * 60 : 300);
  ...
  const isSubmitDisabled = questions.length > 0 && Object.keys(selectedAnswers).length !== questions.length;
