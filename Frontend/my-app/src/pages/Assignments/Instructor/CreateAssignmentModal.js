    ...
    const handleCreateAssignment = async () => {
        ...
        try {
            ...
            if (response.data && response.data.success) {
                ...
                console.error('Failed to create assignment:', response.data);
                setErrorMessage(response.data?.message || 'An unknown error occurred during creation.');
            }
        } catch (error) {//Error during assignment creation...
            ...
            <div className={styles.form}>
                ...
                <div className={styles.modalActions}>
                    ...
                    <button
                        ...
                        disabled={isLoading || !assignmentQuestion.trim() || !assignmentMarks.trim() || !/[a-zA-Z]/.test(assignmentQuestion)} 
                    >
