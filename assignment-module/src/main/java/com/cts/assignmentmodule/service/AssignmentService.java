...
public class AssignmentService {
    ...
    public Assignment createAssignment(AssignmentDTO assignmentdto) throws DuplicateAssignmentException, IllegalArgumentException, UserInputInvalidException {
        ...
        boolean validInstructor=verifyInstructor(assignmentdto.getInstructorId(),assignmentdto.getCourseId().toString());
        System.out.println(validInstructor);
        if(!validInstructor) {
        	throw new InstructorNotAllowedException("Instructor not allowed to create Assignment");
        }
